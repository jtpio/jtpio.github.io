...
- Programming
- Python
slug: "puzzle-pawns-chessboard-square"
---
...
For the [last puzzle](./2015-06-19-solving-schoenbrunn-math-puzzle), we first found a solution manually, and then worked out a computer program to find the answer faster.
