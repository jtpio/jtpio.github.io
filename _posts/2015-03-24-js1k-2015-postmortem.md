...
**[RECOMMENDED]** Live demo (low quality but runs better): [jtpio.github.io/js1k-2015/](//jtpio.github.io/js1k-2015/)
...
Source code: [github.com/jtpio/js1k-2015](//github.com/jtpio/js1k-2015)
...
<img class="center" src="/res/js1k_2015/0_inspiration_0.png">
...
<img class="center" src="/res/js1k_2015/0_inspiration_1.png">
...
<img class="center" src="/res/js1k_2015/0_inspiration_3.png">
...
I got things started with this very useful JS1K boilerplate: [gist.github.com/gre/9364718](//gist.github.com/gre/9364718).
...
I forked the gist mentioned above and extended it to fit my requirements: [gist.github.com/jtpio/547db4510c0bec05bed5](//gist.github.com/jtpio/547db4510c0bec05bed5). It is probably possible to improve it, so feel free to do so!
...
Let's use the [gist](//gist.github.com/jtpio/547db4510c0bec05bed5) mentioned above to minify / compress everything quickly.

For the example, let's take a short shader made by iq for his [formulanimation tutorial](//www.youtube.com/watch?v=0ifChJ0nJfM):
...
Running the tool on this shader (place the above code in the file [shader.fs](//gist.github.com/jtpio/547db4510c0bec05bed5#file-shader-fs)): ``` npm run all ```
...
- The demos mentioned in Paulo Falcao's JS1K compo: [http://js1k.com/2014-dragons/details/1868](http://js1k.com/2014-dragons/details/1868). These:
  - HBC-00012: Kornell Box - [http://www.pouet.net/prod.php?which=61667](http://www.pouet.net/prod.php?which=61667)
  - HBC-00013: Highway 4k - [http://www.pouet.net/prod.php?which=61668](http://www.pouet.net/prod.php?which=61668)
